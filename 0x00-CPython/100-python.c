...
/**
 * convert_to_str - converts a python long int as a string
 * @obj: pointer to python obj (long int)
 * @str: address of char pointer which will be assiged
 * Return: -1 on error else 0
 */
int convert_to_str(PyObject *obj, char **str)
{
	PyLongObject *a;
	...
	*str = digits_to_str(pout, size, negative);
	return (0);
}
